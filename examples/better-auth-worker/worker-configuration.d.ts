/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config examples/better-auth-worker/wrangler.jsonc examples/better-auth-worker/worker-configuration.d.ts` (hash: 3709b0b39fb3dd3065d3e0210728414e)
...
declare namespace Cloudflare {
	...
	interface Env {
		AUTH_HASHER: Fetcher /* cloudflare-auth-hasher-template */;
	}
}
