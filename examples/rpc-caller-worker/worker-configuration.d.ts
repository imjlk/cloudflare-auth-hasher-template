/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config examples/rpc-caller-worker/wrangler.jsonc examples/rpc-caller-worker/worker-configuration.d.ts` (hash: 3709b0b39fb3dd3065d3e0210728414e)
