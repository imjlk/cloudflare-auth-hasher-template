/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.jsonc ./worker-configuration.d.ts` (hash: 8b5e19c2bb1cbc3b2b123afa47d4995c)
...
declare namespace Cloudflare {
	...
	interface Env {
		TS_DIRECT: Fetcher /* auth-hasher-ts-direct */;
		TS_RUST_WASM: Fetcher /* auth-hasher-ts-rust-wasm */;
		RUST_FULL: Fetcher /* auth-hasher-rust-full */;
	}
}
